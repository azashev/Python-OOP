...
class TestMammal(TestCase):
    def setUp(self):
        self.mammal = Mammal("TestName", "some type", "some sound")
    ...
    def test_if_make_sound_returns_correct_message(self):
        ...
        self.assertEqual("TestName makes some sound", result)
    ...
    def test_if_info_returns_correct_message(self):
        ...
        self.assertEqual("TestName is of type some type", result)
