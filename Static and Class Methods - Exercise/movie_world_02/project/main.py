...
#   - If the customer is not allowed to rent the DVD, return "{customer_name} should be at least {dvd_age_restriction}
#     to rent this movie"
#   - Otherwise, the rent is successful (the DVD is rented and added to the customer's DVDs). Return the following:
