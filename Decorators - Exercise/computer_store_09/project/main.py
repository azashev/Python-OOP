...
# he asked you as a programmer to create a program for his store so that he can track the computer's building process
# and the sale process. Your app should have the following structure and functionality.
#
#
# 1. Class Computer:
...
#   - If the string is empty or contains only whitespaces, raise ValueError with the message:
...
#
# __repr__()
#   • Represents the class as:
#       "{ manufacturer } { model } with { processor } and { ram }GB RAM"
#
#
