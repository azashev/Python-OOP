...
#
#
# You are the F1 manager of the two biggest teams in F1, "Red Bull" and "Mercedes". Your task is to create a program
# that calculates the revenue after every race for both teams.
#
#
# Your app should have the following structure and functionality.

# 1. Class FormulaTeam
# In the formula_team.py file, the class FormulaTeam should be implemented. It is a base class for any type of formula
...
#       - If the budget is less than 1 000 000, raise ValueError with the message:
...
#   • To calculate the revenue from the race, sum the earned money from the sponsors depending on the position in the
#     race and subtract the expenses
...
#
# Note: Each sponsor gives the money for the best position only. If you are 1st and the sponsor gives money for 1st and
# 2nd positions, you get the money only for the 1st position!
#
#
#
...
#
# 4. Class F1SeasonApp
# In the f1_season_app.py file, the class F1SeasonApp should be implemented. It will contain all the functionality of
# the project.
#
# Structure:
...
#   • Otherwise, find which team has the better position in the race, calculate every team's revenue, update their
#     budget, and return the following message:
#       "Red Bull: { Red Bull revenue message }. Mercedes: { Mercedes revenue message }. { team with better position }
#       is ahead at the { race name } race."
#
...
# Red Bull: The revenue after the race is 1270000$. Current budget 3270000$. Mercedes: The revenue after the race
# is -150000$. Current budget 2350000$. Red Bull is ahead at the Nurburgring race.
# Red Bull: The revenue after the race is -240000$. Current budget 3030000$. Mercedes: The revenue after the race
# is 900000$. Current budget 3250000$. Mercedes is ahead at the Silverstone race.
