...
# Create a separate file for each class. The Animal class is a base class for any type of animal in the zoo.
# It should receive four public attributes - a name (string), a gender (str), an age (int), and a money_for_care (int)
# upon initialization.
#
#
...
# • hire_worker(worker):
#   - If you have not exceeded the capacity of workers in the zoo for the worker (instance of Keeper/Caretaker/Vet), add
#     him to the workers and return "{name} the {type(Keeper/Vet/Caretaker)} hired successfully"
...
# • tend_animals():
#   - If you have enough budget to take care of the animals, reduce the budget and return "You tended all the animals.
#     They are happy. Budget left: {left_budget}"
